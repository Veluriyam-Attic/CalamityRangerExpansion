...
{
    internal class CondemnationReHold : BaseGunHoldoutProjectile, ILocalizedModType
    {
        public new string LocalizationCategory => "Weapons.EAfterDog";
        public override string Texture => "CalamityRangerExpansion/Content/BOWChange/EAfterDog/CondemnationC/CondemnationRe";
        public override int AssociatedItemID => ModContent.ItemType<CondemnationRe>();
        ...
        public override void HoldoutAI()
        {
            ...
            BowChangeVFX.SpawnCharge(Projectile, GunTipPosition, BowChangeTheme.Condemnation, (stage + chargeProgress) / MaxStage, 0.55f + stage * 0.08f);
        }
        ...
        private void Fire(Player player)
        {
            ...
            int proj = ModContent.ProjectileType<CondemnationReProj>();
            ...
            if (Main.projectile.IndexInRange(index))
            {
                ...
                if (p.ModProjectile is CondemnationReProj spike)
                {
            ...
            BowChangeVFX.SpawnMuzzle(Projectile, GunTipPosition, direction * 25f, BowChangeTheme.Condemnation, 0.65f + stage * 0.12f);
            ...
            if (stage >= 5)
            {
                CondemnationPDebuff.FireMode = 2;
                player.AddBuff(ModContent.BuffType<CondemnationPDebuff>(), 300); // 5秒刷新
            }
            else if (stage >= 3)
            {
                CondemnationPDebuff.FireMode = 1;
                player.AddBuff(ModContent.BuffType<CondemnationPDebuff>(), 300); // 5秒刷新
            }
        ...
        private void TriggerStageEffect(Player player)
        {
            ...
            BowChangeVFX.SpawnReadyBurst(Projectile, GunTipPosition, BowChangeTheme.Condemnation, 0.6f + stage * 0.12f);
        }
