...
{
    internal class CondemnationRe : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<CondemnationReHold>(); // 手持弹幕
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, position, shootDirection, ModContent.ProjectileType<CondemnationReHold>(), damage, knockback, player.whoAmI);
            return false;
        }
