...
{
    public class DarkechoGreatbowReSlash : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            BowChangeVFX.SpawnTrail(Projectile, BowChangeTheme.Darkecho, 0.45f);
        ...
        {
            BowChangeVFX.SpawnImpact(Projectile, BowChangeTheme.Darkecho, 0.75f);
        }
    }
}
