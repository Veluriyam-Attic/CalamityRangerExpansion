...
{
    internal class BarinauticalReSpark : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            Time++;
            BowChangeVFX.SpawnTrail(Projectile, BowChangeTheme.Ocean, 0.35f);
        }
        ...
        {
            BowChangeVFX.SpawnImpact(Projectile, BowChangeTheme.Ocean, 0.45f);
        }
    }
}
