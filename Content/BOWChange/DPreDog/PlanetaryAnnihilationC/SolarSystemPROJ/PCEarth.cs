...
{
    internal class PCEarth : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            LineParticle spark = new LineParticle(Projectile.Center, Projectile.velocity, false, 9, 1.0f, Color.LimeGreen);
            GeneralParticleHandler.SpawnParticle(spark);
        }

        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            target.AddBuff(ModContent.BuffType<PCEarthEDebuff>(), 600);
        }
