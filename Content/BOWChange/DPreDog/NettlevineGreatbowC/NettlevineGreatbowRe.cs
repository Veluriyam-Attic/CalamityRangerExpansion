...
{
    internal class NettlevineGreatbowRe : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<NettlevineGreatbowReHold>(); // 手持弹幕
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                ...
                Projectile.NewProjectile(
                    ...
                    ModContent.ProjectileType<NettlevineGreatbowReRightPROJ>(),
                    damage,
                    knockback,
                    player.whoAmI
                );
            ...
            else
            {
                ...
                Projectile.NewProjectile(
                    ...
                    position,
                    shootDirection,
                    ModContent.ProjectileType<NettlevineGreatbowReHold>(),
                    damage,
                    knockback,
                    player.whoAmI
                );
        ...
        //    Projectile.NewProjectile(source, position, shootDirection, ModContent.ProjectileType<NettlevineGreatbowReHold>(), damage, knockback, player.whoAmI);
        //    return false;
        //}
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<NettlevineGreatbow>();
