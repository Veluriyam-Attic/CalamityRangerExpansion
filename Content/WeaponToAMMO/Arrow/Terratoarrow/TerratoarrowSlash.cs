...
namespace CalamityRangerExpansion.Content.WeaponToAMMO.Arrow.Terratoarrow
{
    public class TerratoarrowSlash : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            {
                Particle spark2 = new GlowSparkParticle(Projectile.Center, new Vector2(0.1f, 0.1f).RotatedByRandom(100), false, 12, Main.rand.NextFloat(0.03f, 0.05f), Color.Green, new Vector2(2, 0.5f), true);
        ...
        public override Color? GetAlpha(Color lightColor) => Color.Lerp(Color.Green, Color.LimeGreen, Projectile.identity / 7f % 1f) * Projectile.Opacity;
