...
{
    public class TheGoldenFirePROJGrow : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnSpawn(IEntitySource source)
        {
            ...
            if (NPC.downedBoss1) Projectile.localNPCHitCooldown -= 1;
            if (NPC.downedBoss2) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedHiveMind) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedPerforator) Projectile.localNPCHitCooldown -= 2; // 示例：这个降低更多
            if (NPC.downedBoss3) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedSlimeGod) Projectile.localNPCHitCooldown -= 1;
            if (Main.hardMode) Projectile.localNPCHitCooldown -= 1;
            if (NPC.downedMechBoss1) Projectile.localNPCHitCooldown -= 1;
            if (NPC.downedMechBoss2) Projectile.localNPCHitCooldown -= 1;
            if (NPC.downedMechBoss3) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedCalamitasClone) Projectile.localNPCHitCooldown -= 1;
            if (NPC.downedPlantBoss) Projectile.localNPCHitCooldown -= 1;
            if (NPC.downedGolemBoss) Projectile.localNPCHitCooldown -= 1;
            if (NPC.downedAncientCultist) Projectile.localNPCHitCooldown -= 1;
            if (NPC.downedMoonlord) Projectile.localNPCHitCooldown -= 2;
            if (DownedBossSystem.downedProvidence) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedSignus) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedStormWeaver) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedCeaselessVoid) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedPolterghast) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedDoG) Projectile.localNPCHitCooldown -= 2;
            if (DownedBossSystem.downedYharon) Projectile.localNPCHitCooldown -= 2;
            if (DownedBossSystem.downedExoMechs) Projectile.localNPCHitCooldown -= 2;
            if (DownedBossSystem.downedCalamitas) Projectile.localNPCHitCooldown -= 1;
            if (DownedBossSystem.downedPrimordialWyrm) Projectile.localNPCHitCooldown -= 1;
