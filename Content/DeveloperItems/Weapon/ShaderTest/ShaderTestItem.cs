...
using CalamityRangerExpansion.Systems;
...
namespace CalamityRangerExpansion.Content.DeveloperItems.Weapon.ShaderTest
{
    public sealed class ShaderTestItem : ModItem, ILocalizedModType
    {
        public const string DemoTexture = "CalamityRangerExpansion/Content/DeveloperItems/Weapon/ShaderTest/CTRLBoss";
