namespace CalamityRangerExpansion.Content.Arrows.DPreDog.UelibloomArrow
{
    public class UelibloomArrowLeaf : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.frame > 4) // 修改为4，以适应五帧贴图
            {
                Projectile.frame = 0;
            }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<UelibloomArrowVine>(), (int)(Projectile.damage * 0.15f), Projectile.knockBack, Projectile.owner);
